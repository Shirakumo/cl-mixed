...
(defun try-formats (audio-client samplerate channels sample-format &optional (mode :shared))
  (let ((channel-formats (list* channels
                          '((:left-front :right-front)
                            ...
                            (:left-front :right-front :center :left-rear :right-rear :left-front-center :right-front-center)
                            (:left-front :right-front :center :left-rear :right-rear :subwoofer :left-front-center :right-front-center)
                            (:left-front)
                            (:center))))
        (last ()))
