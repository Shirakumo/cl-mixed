...
(cffi:defcenum (usage :int32)
  ...
  (:alarm 4)
  (:notification 5)
  (:notification-ringtone 6)
  (:notification-event 10)
  (:assistance-accessibility 11)
  (:assistance-navigation-guidance 12)
  (:assistance-sonification 13)
  (:game 14)
  (:assistant 16)
  (:system-emergency 1000)
  (:system-safety 1001)
  (:system-vehicle-status 1002)
  (:system-announcement 1003))
...
(cffi:defbitfield (channel-mask :int32)
  ...
  (:center-top          #b0000000000000000000100000000000)
  (:left-front-top      #b0000000000000000001000000000000)
  (:center-front-top    #b0000000000000000010000000000000)
  (:right-front-top     #b0000000000000000100000000000000)
  (:left-rear-top       #b0000000000000001000000000000000)
  (:center-rear-top     #b0000000000000010000000000000000)
  (:right-rear-top      #b0000000000000100000000000000000)
  (:left-side-top       #b0000000000001000000000000000000)
  (:right-side-top      #b0000000000010000000000000000000)
  (:left-front-bottom   #b0000000000100000000000000000000)
  (:center-front-bottom #b0000000001000000000000000000000)
  (:right-front-bottom  #b0000000010000000000000000000000)
  (:subwoofer-2         #b0000000100000000000000000000000)
  (:left-front-wide     #b0000001000000000000000000000000)
  (:right-front-wide    #b0000010000000000000000000000000))
