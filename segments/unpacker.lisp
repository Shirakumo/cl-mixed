...
(define-delegated-slot-accessor data unpacker channel)
(define-delegated-slot-accessor size unpacker channel)
(define-delegated-slot-accessor encoding unpacker channel)
(define-delegated-slot-accessor channels unpacker channel)
(define-delegated-slot-accessor layout unpacker channel)
(define-delegated-slot-accessor samplerate unpacker channel)
